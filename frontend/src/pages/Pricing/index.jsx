...
const tiers = [
  {
    title: 'Normal',
    price: '20',
    description: ['1.500 request spam', 'Help center access', 'Email support'],
    text: 'Buy',
    value: 'normal',
  },
  {
    ...
    price: '50',
    description: ['6.000 request spam', 'Save 40% money', 'Phone & email support'],
    text: 'Buy',
    value: 'vip',
  },
  {
    title: 'Pro',
    price: '100',
    description: ['15.000 request spam', 'Save 50% money', 'Phone & email support'],
    text: 'Buy',
    value: 'pro',
  },
];
